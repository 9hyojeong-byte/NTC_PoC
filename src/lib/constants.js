...
/* 레벨별 주차(weekIdx) → 발행 기사 스케줄 (슬롯 순서대로 나열) */
// weekIdx: 2026-01-05 기준 월요일 주차 번호 (이번주=19, 2026-05-18 기준)
export const LEVEL_WEEK_SCHEDULE = {
  "입문": {
    19: ["785","786","121"],
    18: ["101","122","201"],
    17: ["202","301","302"],
...
/* 레벨 × 수업주기 → 신규 학생 자동 배정 기사 목록 */
export const LEVEL_FREQ_SEQS = {
  "입문": { "주2회": ["121","122"], "주3회": ["121","122","201"], "주5회": ["121","122","201","202","301"] },
  "기초": { "주2회": ["301","302"], "주3회": ["301","302","401"], "주5회": ["301","302","401","402","785"] },
  "기본": { "주2회": ["401","121"], "주3회": ["401","121","122"], "주5회": ["401","121","122","402","302"] },
  "심화": { "주2회": ["785","786"], "주3회": ["785","786","401"], "주5회": ["785","786","401","402","302"] },
};

/* 반별 신규 학생 자동 배정 기사 목록 (반 id → articleSeq 배열, 순서 = 발행 순서) */
export const CLASS_DEFAULT_SEQS = {
  c1: ["101", "102", "103"], // 입문반 (KINDER)
  c2: ["201", "202"],        // 기초반 (KIDS)
  c3: ["121", "122"],        // 기본반 (JUNIOR)
  c4: ["401", "402"],        // 심화반 (TIMES)
};

/* 초기 배정 데이터 */
export const IA = {
  // 입문반 (KINDER)
  s1: [{ seq: "101" }, { seq: "102" }, { seq: "103" }],
  s2: [{ seq: "101" }, { seq: "102" }, { seq: "103" }],
  s3: [{ seq: "101" }, { seq: "102" }, { seq: "103" }],
  s4: [{ seq: "101" }, { seq: "102" }, { seq: "103" }],
  // 기본반 (JUNIOR)
  s5: [{ seq: "121" }, { seq: "122" }],
  s6: [{ seq: "121" }, { seq: "122" }],
  s7: [{ seq: "121" }, { seq: "122" }],
